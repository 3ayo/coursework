...
void sortComparison(String[] filenames) throws IOException {
        try (PrintWriter writer = new PrintWriter(new FileWriter("sortComparison.csv"))) {
            // 写入CSV文件的头部
            writer.println(", " + filenames[0].substring(0, filenames[0].indexOf('.')) + ", " + filenames[1].substring(0, filenames[1].indexOf('.')) + ", " + filenames[2].substring(0, filenames[2].indexOf('.')));
            writer.println("bubbleSort, " + measureBubbleSort(filenames[0]) + ", " + measureBubbleSort(filenames[1]) + ", " +measureBubbleSort(filenames[2]));
            writer.println("mergeSort, " + measureMergeSort(filenames[0]) + ", " + measureMergeSort(filenames[1]) + ", " + measureMergeSort(filenames[2]));
